...
I build open-source Python libraries that solve the practical problems around running a Customer Data Platform in production — tag/analytics implementation, audience intelligence, reverse ETL, and the data-pipeline reliability that CDPs depend on. Outside of MarTech, I also build systems-level software for fun (an AI-native OS kernel written in Rust — the SHER OS family).

- 🔭 **Current focus**: Customer Data Platforms, marketing data pipelines, and the Python tooling that supports them
...
### 🔁 [PyReverseETL](https://github.com/Mullassery/PyReverseETL) — Quality-validated data activation
Moves data to where it's needed with a full audit trail, lineage tracking, and compliance records — the activation counterpart to CDP ingestion.

### ✅ [PyAirflowTester](https://github.com/Mullassery/PyAirflowTester) & [StatGuardian](https://github.com/Mullassery/StatGuardian) — Data pipeline reliability
...
<sub>Also building outside the MarTech day job: [SHER OS](https://github.com/Mullassery/SHER-KERNEL), an AI-native operating system kernel in Rust, and [TinyBridge](https://github.com/Mullassery/TinyBridge), a macOS-native Linux VM runtime — see the full index below.</sub>

## 📂 All Repositories

<details open>
<summary><b>MarTech & customer data</b></summary>
...
<details open>
<summary><b>Data pipeline reliability & engineering</b></summary>
...
<details>
<summary>Systems & runtimes (outside the MarTech day job)</summary>
...
**Thanks for stopping by — always happy to talk CDPs, marketing data pipelines, or the Python tooling that makes them reliable.**
